...
export class ProductUseCase implements IProductUseCase {
  ...
  public async getAllProducts(): Promise<Product[]> {
    ...
    return products.map(
      (product) =>
        new Product(product._id, product.name, product.type, product.price, product.rating, product.warrantyYears, product.available),
    )
  }
  ...
  public async getProductById(id: string) {
    ...
    return new Product(product._id, product.name, product.type, product.price, product.rating, product.warrantyYears, product.available)
  }
